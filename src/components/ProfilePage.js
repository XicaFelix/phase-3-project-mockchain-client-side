...
function ProfilePage({userData, appData}){
    let currentUser = appData.filter((user)=> user.seller.name == userData.username)
    console.log(currentUser)
    const transactionList = currentUser.map((record)=>{
